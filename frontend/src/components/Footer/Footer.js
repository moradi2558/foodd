...
const Footer = () => {
  return (
    <div className="tw-relative footer tw-pt-16 lg:tw-px-20 xl:tw-px-32 2xl:tw-px-48 tw-pb-5">
      <div
        className="md:tw-flex"
        style={{ borderBottom: "1px solid rgba(225,225,225,.2)" }}
      >
        <div className="tw-w-full tw-mr-3 tw-mb-5 md:tw-w-4/12">
          <h2 className="tw-text-2xl tw-mb-4">خجالتی نباش ، تماس بگیر!</h2>
          <div className="tw-mr-3">
            <div className="tw-flex tw-items-center tw-mb-4">
              <MdOutlinePlace className="tw-text-yellow-500 tw-text-3xl tw-ml-2" />
              <span>تهران، پاسداران، گلستان سوم</span>
            </div>
            <div className="tw-flex tw-items-center tw-mb-4">
              <FiPhoneCall className="tw-text-yellow-500 tw-text-3xl tw-ml-2" />
              <span>2233445566 - 021</span>
            </div>
            <div className="tw-flex tw-items-center tw-mb-4">
              <FiAtSign className="tw-text-yellow-500 tw-text-3xl tw-ml-2" />
              <span>foodmood@gmail.com</span>
            </div>
            <img src="/images/footer-burger.png" className="tw-mr-5" alt="" />
          </div>
        </div>
        <div className="tw-w-full tw-mb-5 md:tw-w-4/12">
          <h2 className="tw-text-2xl tw-mr-3 tw-mb-4">ساعت کاری</h2>
          <div className="tw-mx-3 sm:tw-mx-16 md:tw-mx-0">
            <div className="work_time_item tw-mb-3">
              <span className="tw-ml-3">شنبه</span>
              <span className="tw-order-3 tw-mr-3 tw-text-yellow-500">8:00 - 20:00</span>
            </div>
            <div className="work_time_item tw-mb-3">
              <span className="tw-ml-3">یکشنبه</span>
              <span className="tw-order-3 tw-mr-3 tw-text-yellow-500">8:00 - 20:00</span>
            </div>
            <div className="work_time_item tw-mb-3">
              <span className="tw-ml-3">دوشنبه</span>
              <span className="tw-order-3 tw-mr-3 tw-text-yellow-500">8:00 - 20:00</span>
            </div>
            <div className="work_time_item tw-mb-3">
              <span className="tw-ml-3">سه شنبه</span>
              <span className="tw-order-3 tw-mr-3 tw-text-yellow-500">8:00 - 20:00</span>
            </div>
            <div className="work_time_item tw-mb-3">
              <span className="tw-ml-3">چهارشنبه</span>
              <span className="tw-order-3 tw-mr-3 tw-text-yellow-500">8:00 - 20:00</span>
            </div>
            <div className="work_time_item tw-mb-3">
              <span className="tw-ml-3">پنجشنبه</span>
              <span className="tw-order-3 tw-mr-3 tw-text-yellow-500">8:00 - 20:00</span>
            </div>
            <div className="work_time_item tw-mb-3">
              <span className="tw-ml-3">جمعه</span>
              <span className="tw-order-3 tw-mr-3 tw-text-yellow-500">بسته</span>
            </div>
          </div>
        </div>
        <div className="tw-w-full tw-px-3 tw-mb-5 md:tw-w-4/12">
          <h2 className="tw-text-2xl tw-mb-4 xl:tw-mr-9">گالری</h2>
          <div className="tw-flex tw-justify-center">
            <div className="tw-grid tw-grid-cols-3 tw-justify-center tw-gap-2.5 tw-mx-1 tw-w-fit">
              <div className="tw-relative footer_gallery_container tw-w-fit">
                <div className="footer_gallery_item">
                  <img
                    className="tw-h-24 tw-w-24 tw-rounded-lg footer_gallery_img"
      ...
      <div>
        <div className="tw-flex tw-space-x-5 tw-space-x-reverse tw-mt-4 tw-justify-center md:tw-justify-end md:tw-pl-3">
          <BsTwitterX
            fontSize={26}
            className="hover:tw-text-yellow-500 tw-cursor-pointer tw-transition tw-duration-300"
          />
          <FaTelegramPlane
            fontSize={26}
            className="hover:tw-text-yellow-500 tw-cursor-pointer tw-transition tw-duration-300"
      ...
      <div className="tw-absolute tw--top-2 sm:tw--top-3 lg:tw--top-6 tw-left-0 tw-z-20 tw-w-full tw-rotate-180">
      <svg
          viewBox="0 0 1920 50.8"
